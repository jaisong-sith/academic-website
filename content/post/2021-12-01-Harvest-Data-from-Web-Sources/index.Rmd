...
เราจะเห็นว่าตารางที่เราได้มาจากเวป มันยังไม่พร้อมที่จะเอาไปใช้ได้เลย เพราะว่า ยังมีคอลัมน์ที่เราไม่ใช้ หรือ แถวบางแถวที่เราไม่ใช้ ดังนั้นเราจะต้องเอาออก
นั้นคือ แถวที่  1 และ 3 และ คอลัมน์ที่ 1 3 และ 5 จึงได้
...
จากที่เราเห็นโครงสร้าง url ของเวปแล้ว `http://thaiastro.nectec.or.th/skyevnt/sunmoon/2021/krabi.html` จะเห็นว่า `/2021/krabi.html` ขึ้นด้วยปี และ ต่อด้วยจังหวัด
ดังนั้น เราจะต้องเปิด ปี และ จังหวัด ไปทีละ หน้า แล้ว ดึงข้อมูล ทั้ง 12 เดือน เราจึงต้องใช้ loop ช่วย และ นี่ คือ ขั้นตอนการดึงข้อมูล
