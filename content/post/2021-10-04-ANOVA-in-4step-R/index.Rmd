...
```
# เกริ่น
ผมคนข้าง ๆ ตัวผม หลายคน ถามเรื่องการวิเคราะห์ ANOVA โดย โปรแกรม R ผมจะไม่อถิบายว่า ANOVA คืออะไร เพราะว่าถ้าถามแล้วแสดงว่า อยากจะวิเคราะห์ บางที ไม่รู้อะไร ก็ วิเคราะห์ ANOVA ไว้ก่อน โดยไม่สนอะไร เอาเป็นว่า สอนง่าย ๆ เลย  มี 4 ขั้นตอน ดังนี้
...
้ตีความลักษณะของความแตกต่างของกลุ่ม โดยการสร้าง การถดถอยเชิงเส้นโดยใช้ `lm()` แทน `aov()` ในขั้นตอนที่ 1
```{r eval=FALSE}
...
ถ้าอยากอ่านหรือทำความเข้าใจเกี่ยวกับ ANOVA มากขึ้น อยากแนะนำให้อ่าน [ANOVA Cookboo](https://benwhalley.github.io/just-enough-r/anova-cookbook.html#howell-factorial-example) จะเห็นอะไรที่น่าสนใจ
